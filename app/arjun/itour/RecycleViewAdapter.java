...
import static app.arjun.itour.R.id.btn_img_loc;
...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.ViewHolder> {
    ...
    public RecycleViewAdapter(ArrayList<String>al_img_tour, ArrayList<String>al_name_tour, ArrayList<String>al_desc_tour, ArrayList<String> al_price_tour, ArrayList<String> al_location, Context context){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        Glide.with(context).load(al_img_tour.get(position)).into(holder.imgTour);

        holder.nameTour.setText(al_name_tour.get(position));
//        holder.locTour.setText(al_desc_tour.get(position));
        holder.priceTour.setText(Integer.toString(Integer.parseInt(al_price_tour.get(position))));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            locTour = itemView.findViewById(btn_img_loc);
